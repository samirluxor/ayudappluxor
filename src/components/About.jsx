    ...
    },
    {
      ...
      content: (
        <>
          ...
          <p className="text-gray-600 leading-relaxed">
            La <strong>MANOS QUE UNEN</strong> es parte de este esfuerzo: una plataforma gratuita, de código 
    ...
    },
    {
      ...
      content: (
        <>
          ...
          <p className="text-gray-600 leading-relaxed">
            Cada encuesta registrada en MANOS QUE UNEN representa una familia que necesita ser escuchada 
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-8">
      <div className="text-center">
        <img src="/logo.webp" alt="MANOS QUE UNEN" className="max-w-xs mx-auto mb-4 object-contain" />
      ...
      <p className="text-center text-sm text-gray-400 pb-8">
        MANOS QUE UNEN &copy; {new Date().getFullYear()} &mdash; Una iniciativa de Supermercados Luxor
      </p>
    </div>
  )
}