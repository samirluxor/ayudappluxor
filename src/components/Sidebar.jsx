...
const navItems = [
  ...
  { label: 'Más de MANOS QUE UNEN', path: '/about', icon: InformationCircleIcon, adminOnly: false },
]
      ...
      <div className="p-5 border-b border-gray-200">
        <div className="flex items-center gap-3">
          ...
          <div className="min-w-0">
            <p className="font-bold text-gray-800 text-sm truncate">MANOS QUE UNEN</p>
    ...
    <>
      <div className="lg:hidden fixed top-0 left-0 right-0 z-30 bg-white border-b border-gray-200 px-3 py-2 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <span className="font-bold text-gray-800 text-sm">MANOS QUE UNEN</span>
        </div>
        <SyncStatus />
      </div>
